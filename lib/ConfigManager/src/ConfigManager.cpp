...
void ConfigManager::startConfigMode(){
  ...
  if (!wifiManager.startConfigPortal("TemperatureSensor")) {
...
void ConfigManager::autoConnect() {
  ...
  wifiManager.autoConnect("TemperatureSensor");
